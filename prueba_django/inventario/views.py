...
def crear_producto(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request, "inventario/product_form.html", {"form": form, "error": True}
            )
    else:
        form = ProductoForm()
...
def editar_producto(request, id):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(
                request,
                "inventario/product_form.html",
                {"form": form, "editar": True, "error": True},
            )
    else:
        form = ProductoForm(instance=producto)

    return render(
        request, "inventario/product_form.html", {"form": form, "editar": True}
    )
